...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.WAYPOINT:
        	distance = abs(self.local_position - self.target_position[:3])
	        if (distance[0] < 0.1 and distance[1] < 0.5):
    ...
    def takeoff_transition(self):
        ...
        target_altitude = 5
        #self.target_position[2] = target_altitude#self.all_waypoints[0]
    ...
    def waypoint_transition(self):
        ...
        waypoint_index = 0 #self.all_waypoints.index(self.target_position)
